...
This project uses a **5-agent + 6-skill** system. The agents orchestrate analysis end-to-end; skills are reusable instruction modules invoked by multiple agents.

**Start here:** `document/agents/00_system_overview.md` — orchestration loop, handoff triggers, hard rules.

### Agents

| # | Agent | File | Focus |
|---|-------|------|-------|
| 01 | CEO | `agents/01_ceo.md` | Strategy, scoping, non-analyst review |
| 02 | Data Engineer | `agents/02_data_engineer.md` | SQL, schema, data access |
| 03 | Data Scientist | `agents/03_data_scientist.md` | Templates, code, visualizations, ML |
| 04 | Quality Guardian | `agents/04_quality_guardian.md` | Validation, accuracy, pitfall detection |
| 05 | Story Teller | `agents/05_storyteller.md` | Non-analyst narrative, exec delivery |

### Skills

| Skill | File | Used by |
|-------|------|---------|
| Template Selector | `skills/skill_template_selector.md` | CEO, Data Scientist |
| SQL Builder | `skills/skill_sql_builder.md` | Data Engineer |
| Data Validation | `skills/skill_data_validation.md` | Quality Guardian, Data Scientist |
| Visualization | `skills/skill_visualization.md` | Data Scientist |
| Insight Delivery | `skills/skill_insight_delivery.md` | Story Teller, CEO |
| Katakana Encoder | `skills/skill_katakana_encoder.md` | Data Engineer, Quality Guardian |
...
**✅ ALWAYS refer to IDPOS_REFERENCE.md for exact column names and values**
...
## Detailed Guidance → Agent & Skill Files

All detailed analysis logic, SQL patterns, validation checklists, visualization standards, and delivery templates have been moved to `document/agents/` and `document/skills/`. The sections below are retained as historical reference.

| Topic | Canonical location |
|-------|-------------------|
| Analysis framework, template selection | `agents/01_ceo.md` + `skills/skill_template_selector.md` |
| SQL query patterns | `skills/skill_sql_builder.md` |
| Data quality checks | `skills/skill_data_validation.md` |
| Chart type selection, formatting | `skills/skill_visualization.md` |
| Executive output structure | `skills/skill_insight_delivery.md` |
| Katakana encoding reference | `skills/skill_katakana_encoder.md` |
| Common pitfalls | `agents/04_quality_guardian.md` |

---

## 💡 Strategic Analysis Framework (Historical Reference)
